...
class QwenFilter:
    def __init__(self, model_dir: str = None, model=None, processor=None, threshold: float = 0.75, device: str = "auto", cache_dir: str = "/user/majunxian/.cache/modelscope"):
        """
        Args:
            model_dir: Directory of Loaded Model
            threshold: Similarity threshold
            device: cuda or cpu 
            cache_dir: Custom cache directory for model storage
        """
        if device == "auto":
